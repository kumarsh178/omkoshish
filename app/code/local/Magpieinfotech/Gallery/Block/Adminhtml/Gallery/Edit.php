...
class Magpieinfotech_Gallery_Block_Adminhtml_Gallery_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
		...
		public function getHeaderText()
		{
				if( Mage::registry("gallery_data") && Mage::registry("gallery_data")->getId() ){
				    ...
				    return Mage::helper("gallery")->__("Edit Item '%s'", $this->htmlEscape(Mage::registry("gallery_data")->getId()));
